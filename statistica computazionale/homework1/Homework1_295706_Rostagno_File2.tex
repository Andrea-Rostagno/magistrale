...
\begin{itemize}
	...
	A questo punto ho campionato il vettore $y \sim N(1,6)$ ed il vettore $u \sim U(0,M*g(y))$ e ho accettato i campioni di y che soddisfassero $u < f(y)$ dove in questo caso f(y) è il kernel che abbiamo usato (nel codice il kernel è indicato come posteriori non normalizzata).
	Sono stati accettati 1114 campioni.\\
